...
DB_PATHS = {
    "8-K":    os.path.join(SEC_DB_DIR, "sec_8k.db"),
    "S-4":    os.path.join(SEC_DB_DIR, "sec_s4.db"),
    "SC 13D": os.path.join(SEC_DB_DIR, "sec_13.db"),
    "SC 13G": os.path.join(SEC_DB_DIR, "sec_13.db"),
    "144":    os.path.join(SEC_DB_DIR, "sec_144.db"),
}
